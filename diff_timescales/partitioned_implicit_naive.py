...
if __name__ == '__main__':
    # t_stop = 10
    # N = 50
    # erk_sol = partitioned_erk(t_stop, N, 2, "implicit-cps", sc=10, interpolation_order=0)
    # create_solution_plots(np.linspace(0,t_stop,N+1), erk_sol, "implicit-subcycling-erk2-0")

    t_stop = 20
    N_list = np.array([125, 250, 500, 1000, 2000])
    ...
    ax = beautify_plot(ax)
    plt.savefig("convergence_diff_timescales_partitioned_implicit_0.png", dpi=300, bbox_inches='tight')