...
if __name__ == '__main__':
    ...
    ax.plot(dt_list, errors_newmark_strang, linestyle="none", marker="3", color="maroon", label=r"Newmark-$\beta$")
    ...
    ax = beautify_plot(ax)
    plt.savefig("convergence_diff_timescales_partitioned_strang.pdf", dpi=300, bbox_inches='tight')