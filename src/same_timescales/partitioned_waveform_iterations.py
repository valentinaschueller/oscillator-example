...
if __name__ == '__main__':
    ...
    errors_newmark_strang = np.array([max_norm(compute_newmark_error(t_stop, N, "implicit-css")) for N in N_list])
    errors_alpha_strang = np.array([max_norm(compute_alpha_error(t_stop, N, "implicit-css")) for N in N_list])
    errors_erk4_strang = np.array([max_norm(compute_erk4_error(t_stop, N, "implicit-css")) for N in N_list])
