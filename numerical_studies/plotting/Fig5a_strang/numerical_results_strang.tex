...
\addplot[mark=x,blue,only marks] table[x=dt , y=error, col sep=comma]{\resultsdir/partitioned_sie_strang.csv};
\addlegendentry{SIE};

\addplot[mark=star,only marks,blue] table[x=dt , y=error, col sep=comma]{\resultsdir/partitioned_newmark_strang.csv};
\addlegendentry{Newmark-$\beta$};

\addplot[mark=o,blue,only marks] table[x=dt , y=error, col sep=comma]{\resultsdir/partitioned_alpha_strang.csv};
\addlegendentry{generalized-$\alpha$};

\addplot[mark=triangle,blue,only marks] table[x=dt , y=error, col sep=comma]{\resultsdir/partitioned_mid_strang.csv};
\addlegendentry{Impl. midpoint};

\addplot[mark=square,blue,only marks] table[x=dt , y=error, col sep=comma]{\resultsdir/partitioned_erk4_strang.csv};
\addlegendentry{ERK4};
