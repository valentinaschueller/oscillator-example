...
\begin{tikzpicture}
    ...
    \addplot[mark=x,blue,only marks] table[x=dt , y=error, col sep=comma]{\resultsdir/monolithic_sie.csv};
    \addlegendentry{SIE};

    \addplot[mark=star,blue,only marks] table[x=dt , y=error, col sep=comma]{\resultsdir/monolithic_newmark.csv};
    \addlegendentry{Newmark-$\beta$};

    \addplot[mark=o,blue,only marks] table[x=dt , y=error, col sep=comma]{\resultsdir/monolithic_alpha.csv};
    \addlegendentry{generalized-$\alpha$};

    \addplot[mark=triangle,blue,only marks] table[x=dt , y=error, col sep=comma]{\resultsdir/monolithic_mid.csv};
    \addlegendentry{Impl. midpoint};

    \addplot[mark=square,blue,only marks] table[x=dt , y=error, col sep=comma]{\resultsdir/monolithic_erk4.csv};
    \addlegendentry{ERK4};
